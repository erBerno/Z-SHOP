...
import { FaEnvelope, FaHeadphones, FaPhone } from "react-icons/fa6";
  ...
  return (
    <>
      <div className="topbar border-b border-gray-800">
        <ul>
          <li>
            <FaPhone className="text-2xl max-sm:text-lg text-accent-content" />
            <span className="text-2xl max-sm:text-lg text-accent-content">
              +591 79367642
            </span>
          </li>
          <li>
            <FaEnvelope className="text-2xl max-sm:text-lg text-accent-content" />{" "}
            <span className="text-2xl max-sm:text-lg text-accent-content">
              support@zshop.com
            </span>
          </li>
